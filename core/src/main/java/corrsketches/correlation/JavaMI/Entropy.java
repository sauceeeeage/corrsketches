...
public abstract class Entropy
{
  ...
  {
    JointProbabilityState state = new JointProbabilityState(dataVector,conditionVector,MutualInformation.numOfBuckets);
  ...
  {    
    JointProbabilityState state = new JointProbabilityState(firstVector,secondVector,MutualInformation.numOfBuckets);
